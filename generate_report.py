...
story.append(Paragraph("10. Evaluation", h1))
story.append(Paragraph(
...
story.append(Paragraph("11. Limitations", h1))
limitations = [
...
story.append(Paragraph("12. Reproducibility", h1))
commands = [
...
story.append(Paragraph("13. Architecture", h1))
story.append(Paragraph(
...
future = [
    ...
    "Evaluate additional AdaIN alpha values and multiple style images.",
...
story.append(Paragraph("15. References", h1))
references = [
